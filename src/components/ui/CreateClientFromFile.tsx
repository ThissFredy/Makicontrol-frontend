...
import { uploadCustomersFileService } from "@/services/customerService";
...
export const CreateClientFromFile = ({
    onClose,
    onSuccess,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await uploadCustomersFileService(formData);
