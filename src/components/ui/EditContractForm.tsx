...
export const EditContractForm = ({
    ...
    useEffect(() => {
        if (initialData) {
            setData({
                ...
                valorCanon: initialData.valorCanon,
                valorBaseEquipo: initialData.valorBaseEquipo,
                periodo: initialData.periodo,
                fechaInicio: initialData.fechaInicio,
                fechaFin: initialData.fechaFin,
                estado: initialData.estado,
                canones: initialData.canones,
            });
        }
    }, [initialData]);
    ...
    const handleChange = async (
        ...
        const data = {
            ...dataForm,
            [name]: name === "clienteNit" ? Number(value) : value,
        };
        setData(data);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setIsLoading(true);
        setApiError(null);
        const response = await updateCustomerService(dataForm);
        ...
        >
            <div className="mb-6">
                ...
                <p className="mt-1 text-slate-500">
                    Completa la información para editar el contrato.
                </p>
            </div>
